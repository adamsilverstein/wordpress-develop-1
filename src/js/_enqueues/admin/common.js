...
$document.ready( function() {
	...
	window.wpResponsive = {
		...
		init: function() {
			...
			$( '.columns-prefs input' ).on( 'click', this.maybeDisableSortables );
		},

		/**
		 * Disable sortables if there is only one metabox, and the screen is in one column mode. Otherwise, enable sortables.
		 */
